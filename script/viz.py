...
if __name__ == "__main__":
    ...
    viz_CAMPD(date="1221", target="QH", n_sample=384, save_fig=saveFig)
    viz_CAPD(date="1221", solvent="C2H6O2", target="QH", n_sample=1024, save_fig=saveFig)

    # Case 2: minimization of total annual cost
    viz_CAMPD(date="1221", target="TAC", n_sample=384, save_fig=saveFig)
    viz_CAPD(date="1221", solvent="C2H6O2", target="TAC", n_sample=128, save_fig=saveFig)
