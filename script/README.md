...
- `process_simulation_CAMPD.py`: process simulation with given solvent and process parameters (for CAMPD)

- `process_simulation_CAPD.py`: process simulation with given process parameters (for process design)
...
- `utility_params.py`: parameters/configurations used for the entire project
