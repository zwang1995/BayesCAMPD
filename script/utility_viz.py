# Created on 12 Jun 2023 by Zihao Wang
...
def figure_1(paths, target, save_fig=True):
    ...
    if target == "QH":
        y_label = "Q$_H$ (MW)"
        ylim1_dict = {"CAMPD": extend_xylim(0, 50, onlyUp=True), "CAPD": extend_xylim(8, 16)}
        ylim2_dict = {"CAMPD": extend_xylim(0, 9, onlyUp=True), "CAPD": extend_xylim(0, 3, onlyUp=True)}
    else:
        y_label = "TAC (MM$/yr)"
        ylim1_dict = {"CAMPD": extend_xylim(0, 15, onlyUp=True), "CAPD": extend_xylim(2, 6)}
        ylim2_dict = {"CAMPD": extend_xylim(0, 6, onlyUp=True), "CAPD": extend_xylim(0, 3, onlyUp=True)}
    ...
    for c in time_by_step.keys():
        print(c, time_by_step[c])
...
def figure_2A(paths, target, n_sample, save_fig=True):
    ...
    if target == "QH":
        y_label = "Q$_H$ (MW)"
        ylim1_dict = {"CAMPD": extend_xylim(9, 21), "CAPD": extend_xylim(9, 13)}
        ylim2_dict = {"CAMPD": extend_xylim(0, 8.5, onlyUp=True), "CAPD": extend_xylim(0, 2, onlyUp=True)}
    else:
        y_label = "TAC (MM$/yr)"
        ylim1_dict = {"CAMPD": extend_xylim(1, 10), "CAPD": extend_xylim(2.5, 5)}
        ylim2_dict = {"CAMPD": extend_xylim(0, 4, onlyUp=True), "CAPD": extend_xylim(0, 1.5, onlyUp=True)}
